		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Proyecto de pruebas 02",
									"targetURL": "#lorkgroupproject02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"lorkgroupproject02-display": {
								"semanticObject": "lorkgroupproject02",
								"action": "display",
								"description": "Proyecto de pruebas 02 Descripcion",
								"title": "Proyecto de pruebas 02",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=lorkgroup.project02",
									"url": sap.ui.require.toUrl("lorkgroup/project02")
								}
							}
						}
					}
